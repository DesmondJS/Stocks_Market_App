    ...
    return (
        <div className="rounded-2xl border border-gray-700/80 bg-gray-900/60 shadow-xl p-5 space-y-3">
            <div className="flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
                ...
                <Button onClick={handleSummarize} disabled={loading} className="yellow-btn px-4 min-w-35">
                    {loading ? "Summarizing…" : "Summarize"}
                </Button>
            </div>
            <div className="rounded-xl border border-gray-700 bg-gray-900/80 p-4 min-h-25 text-gray-100 whitespace-pre-wrap">
