...
const WatchlistPage = async () => {
    ...
    if (!symbols?.length) {
        return (
            <section className="container py-10 space-y-6">
                <div className="rounded-2xl bg-linear-to-br from-gray-800 to-gray-900/80 border border-gray-700/80 px-6 py-8 shadow-xl">
    ...
    return (
        <section className="container py-10 space-y-6">
            <div className="rounded-2xl bg-linear-to-br from-gray-800 to-gray-900/80 border border-gray-700/80 px-6 py-8 shadow-xl flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
